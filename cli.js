...
var directives = require(questionnaireFile);
var quiz = Quizomatic.create(directives, { randomize: true });
var responseFilePrefix = directives.key || "love-languages-test";
...
function presentQuestion(data) {
  ...
  if (current.question) {
    ...
    console.log(
      "Which describes you best (if torn between two, think of your childhood)?"
    );
  }
...
function interpretAnswer(num) {
  ...
  if (!quiz.respond(Number(num) - 1)) {
    console.log(
      "Sorry, I didn't understand you. Respond again with 1, 2, or 'p' (for previous question)"
    );
    return;
  }
  console.log("");
...
console.log("");
console.log(
  "Read the question, type your answer (1 or 2), and hit enter to submit"
);
console.log("");
