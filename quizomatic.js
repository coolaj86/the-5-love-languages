...
(function (exports) {
  ...
  function Quizomatic(directives, opts) {
    ...
    me._total = me._remainingQuestions.length;
    me._doneQuestions = [];
  ...
  proto.next = function () {
    ...
    return {
      current: me._current,
      remaining: me._remainingQuestions.length,
      total: me._total,
    };
  };
  ...
  proto.respond = function (i) {
    ...
    me._responses.answers[me._current.number] =
      me._groups[me._current.choices[i].group];
